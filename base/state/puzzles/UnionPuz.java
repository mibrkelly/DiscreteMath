...
import base.state.expPages.UnionExp;
...
public class UnionPuz extends Calculator {
	...
	public State whichState(int x, int y) {
		if (logicX == 2*3*5) {
			open(13);
			State s = new PuzMenu(getWidth(),getHeight(),"You have solved the \"union\" puzzle! Please continue!");
			return s;
		}
	...
	public void write(Graphics g) {
		...
		g.drawString("Your goal is to create the set that contains all of A and B.", 15, 470);
