...
import base.state.puzzles.PartitionPuz;
...
public class PartitionExp extends State {
	private Pieces[] pieces;
	
	public PartitionExp(int w, int h) {
		super(w,h);
		pieces = new Pieces[4];
	...
	public State whichState(int x, int y) {
		...
		if (980 < x && x < 1080 && 510 < y && y < 540) {
			State s = new PartitionPuz(getWidth(), getHeight());
			return s;
		}
		return this;
	}
