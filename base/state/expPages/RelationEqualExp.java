...
import base.state.puzzles.EquivalencePuz;
...
public class RelationEqualExp extends State {
	private Pieces[] pieces;
	
	public RelationEqualExp(int w, int h) {
		super(w,h);
		pieces = new Pieces[4];
	...
	public void write(Graphics g) {
		...
		g.drawString("Welcome to the equivalence puzzle!", 150,100);
