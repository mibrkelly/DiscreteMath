...
import base.state.puzzles.ContradictionPuz;
...
public class ContradictionExp extends State {
	private Pieces[] pieces;
	
	public ContradictionExp(int w, int h) {
		super(w,h);
		pieces = new Pieces[2];
	...
	public State whichState(int x, int y) {
		...
		if (980 < x && x < 1080 && 510 < y && y < 540) {
			State s = new ContradictionPuz(getWidth(), getHeight());
			return s;
		}
		return this;
	}
