...
import base.state.puzzles.SurjectivePuz;
import java.awt.Graphics;
import java.awt.Color;

public class SurjectiveExp extends State {
	
	public SurjectiveExp(int w, int h) {
		super(w,h);
	}
	...
	public void write(Graphics g) {
		...
		g.drawString("This is the surjective functions puzzle.", 150,100);
		g.drawString("You can create a function by linking each point in the domain to a point in the range.", 150,120);
		g.drawString("A surjective function maps to each point in the range.", 150,140);
