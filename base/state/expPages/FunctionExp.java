...
import base.state.puzzles.FunctionPuz;
...
public class FunctionExp extends State {
	private Pieces[] pieces;
	
	public FunctionExp(int w, int h) {
		super(w,h);
		pieces = new Pieces[4];
	...
	public void write(Graphics g) {
		...
		g.drawString("Welcome to the functions puzzle!", 150,100);
	...
	public State whichState(int x, int y) {
		...
		if (980 < x && x < 1080 && 510 < y && y < 540) {
			State s = new FunctionPuz(getWidth(), getHeight());
			return s;
		}
		return this;
	}
