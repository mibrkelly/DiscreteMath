...
import base.state.puzzles.BijectivePuz;
import java.awt.Graphics;
import java.awt.Color;

public class BijectionExp extends State {
	
	public BijectionExp(int w, int h) {
		super(w,h);
	}
	...
	public void write(Graphics g) {
		...
		g.drawString("This is the bijective functions puzzle.", 150,100);
		g.drawString("You can create a function by linking each point in the domain to a point in the range.", 150,120);
		g.drawString("A bijective function is both injective and surjective.", 150,140);
