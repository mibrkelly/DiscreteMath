...
import base.state.puzzles.SetCrossPuz;
...
public class SetCrossExp extends State {
	private Pieces[] pieces;
	
	public SetCrossExp(int w, int h) {
		super(w,h);
		pieces = new Pieces[4];
	...
	public void write(Graphics g) {
		...
		g.drawString("Welcome to the cross product puzzle!", 150,100);
