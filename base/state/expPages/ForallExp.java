...
public class ForallExp extends State {
	
	private Pieces[] pieces;
	
	public ForallExp(int w, int h) {
		super(w,h);
	...
	public State whichState(int x, int y) {
		if (130 < x && x < 230 && 510 < y && y < 540) {
			State s = new PuzMenu(getWidth(), getHeight(),"You have opened the \"for all\" path! Please select a puzzle.");
			return s;
		}
		return this;
	}
