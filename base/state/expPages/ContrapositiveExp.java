...
import base.state.puzzles.ContrapositivePuz;
...
public class ContrapositiveExp extends State {
	private Pieces[] pieces;
	
	public ContrapositiveExp(int w, int h) {
		super(w,h);
		pieces = new Pieces[2];
	...
	public State whichState(int x, int y) {
		...
		if (980 < x && x < 1080 && 510 < y && y < 540) {
			State s = new ContrapositivePuz(getWidth(), getHeight());
			return s;
		}
		return this;
	}
